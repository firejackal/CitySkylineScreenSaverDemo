...
#region Update Code
    public void UpdateLocation(string location, bool threaded = true)
    {
        ...
        if(!threaded) {
            GoogleGeocodeAPI.Results results = GoogleGeocodeAPI.GetLocation(location);
            if(results != null) UpdateLocation(results.lat, results.lng);
        } else
    ...
    private void UpdateLocation(GoogleGeocodeAPI.Results results)
    {
    ...
    public void UpdateWeather(bool threaded = true)
    {
        ...
        if(!threaded) {
            if(String.IsNullOrEmpty(Scene.Options.OverrideWeatherCondition)) {
                GoogleWeatherAPI.Conditions condition = GoogleWeatherAPI.GetCurrentConditions(this.Location);
    ...
    public void UpdateWeather(GoogleWeatherAPI.Conditions condition)
    {
    ...
    public void UpdateWeather(string condition)
    {
        ...
        switch(condition.ToLower()) {
            case("mostly_sunny")  : this.Cloudiness = CloudinessTypes.Light; break;
            case("partly_cloudy") : this.Cloudiness = CloudinessTypes.Partly; break;
            case ("mostly_cloudy") : this.Cloudiness = CloudinessTypes.Mostly; break;
            case ("cloudy") : this.Cloudiness = CloudinessTypes.Full; break;

            case ("mist") : this.PrecType = PrecipitationTypes.Raining; this.Cloudiness = CloudinessTypes.Full; this.Precipitation = Precipitations.Light; break;
            case ("rain") : this.PrecType = PrecipitationTypes.Raining; this.Cloudiness = CloudinessTypes.Full; this.Precipitation = Precipitations.Light; break;
            case ("showers") : this.PrecType = PrecipitationTypes.Raining; this.Cloudiness = CloudinessTypes.Full; this.Precipitation = Precipitations.Medium; break;
            case ("storm") : this.PrecType = PrecipitationTypes.Raining; this.Cloudiness = CloudinessTypes.Full; this.Precipitation = Precipitations.Heavy; break;
            case ("thunderstorm") : this.PrecType = PrecipitationTypes.Raining; this.IsLightning = true; this.Cloudiness = CloudinessTypes.Full; this.Precipitation = Precipitations.Heavy; break;

            case ("snow") : this.PrecType = PrecipitationTypes.Snowing; this.Cloudiness = CloudinessTypes.Full; this.Precipitation = Precipitations.Medium; break;
            //case("snow") : this.PrecType = PrecipitationTypes.Snowing; this.Cloudiness = CloudinessTypes.Full; this.Precipitation = Precipitations.Heavy; break;

            case ("sleet"):
            case ("rain_snow"):
            case ("icy") : this.PrecType = PrecipitationTypes.Sleeting; this.Cloudiness = CloudinessTypes.Full; this.Precipitation = Precipitations.Medium; break;
            ...
            //case("chance_of_rain"): break;
            //case("chance_of_storm"): break;
            //case("chance_of_snow"): break;
            //case("chance_of_tstorm"): break;
        }
